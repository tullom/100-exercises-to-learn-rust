...
impl Ticket {
    pub fn new(title: String, description: String, status: String) -> Ticket {
        Ticket::check_if_title_valid(&title);
        Ticket::check_if_description_valid(&description);
        Ticket::check_if_status_valid(&status);
    ...
    pub fn check_if_title_valid(title: &String) {
        if title.is_empty() {
    ...
    pub fn check_if_description_valid(description: &String) {
    ...
    pub fn check_if_status_valid(status: &String) {
